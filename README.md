...
Automação de comentários para DM no Instagram usando a API oficial da Meta.

[![License: MIT](https://img.shields.io/badge/License-MIT-black.svg)](LICENSE)
[![Stars](https://img.shields.io/github/stars/ricartecinf-hue/easyflow?style=flat&color=black)](https://github.com/ricartecinf-hue/easyflow/stargazers)
[![Built with Next.js](https://img.shields.io/badge/Next.js-16-black.svg)](https://nextjs.org)

</div>

Someone comments `LINK` on your reel, and they get a DM with your link a second later. That is the whole idea. EasyFlow watches the comments on your Instagram posts, and when a comment matches a keyword you set, it sends that person a private reply through the official Meta API. You can also post a public reply under the comment at the same time.

ManyChat does this and charges a monthly fee. EasyFlow is the same core feature, free, running on your own infrastructure, with no seat limits and no plan caps.
...
EasyFlow is built around Meta's official Instagram private replies. It does not scrape, it does not automate a browser, and it never asks for an Instagram password. That keeps your account inside Meta's rules, which matters if you care about not getting flagged.
...
2. Meta sends a webhook to your EasyFlow instance.
3. EasyFlow checks the comment against your active campaigns.
...
[Veja o guia de implantação no Easypanel](docs/easypanel.md).

### Run it locally

```bash
git clone https://github.com/ricartecinf-hue/easyflow.git
cd easyflow
npm install
...
EasyFlow é um fork de [OpenReply](https://github.com/diwenne/openreply),
mantido originalmente por [Diwen Huang](https://github.com/diwenne). O OpenReply,
por sua vez, é um fork de
[instagram-comment-to-dm](https://github.com/im-anishraj/instagram-comment-to-dm),
de [Anish Raj](https://github.com/im-anishraj). Os projetos usam a licença MIT.

## Star the repo

If EasyFlow is useful to you, star it. It is the simplest way to help the project reach the next person looking for a free way to do this.
